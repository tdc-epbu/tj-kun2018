...
public class CourceFactory {
	...
	public static Course create(CourceType courceType){
		...
		case STAIRS:
			...
			break;
		case RIGHT2017:
			sectionList = createRight2017Cource();
			break;
		case LEFT2017:
			sectionList = createLeft2017Cource();
			break;
		default:
			sectionList = createLeftCource();
		}
	...
	private static List<Section> createLeft2017Cource() {
...
//		sectionList.add(new Section(speed6, TravelType.PID, condition6, null));
		...
		Condition condition8 = new Condition(ConditionType.DISTANCE, 2700);
		sectionList.add(new Section(speed8, TravelType.PID, condition8, null));
		//急なカーブ
		WheelSpeed speed9 = new WheelSpeed(30, 30);
		Condition condition9 = new Condition(ConditionType.DISTANCE, 2800);
		sectionList.add(new Section(speed9, TravelType.PID, condition9, null));
		//急なカーブ
		WheelSpeed speed10 = new WheelSpeed(10, 10);
		Condition condition10 = new Condition(ConditionType.DISTANCE, 2500);
		sectionList.add(new Section(speed10, TravelType.JAGGY, condition10, null));


		return sectionList;
	}

	private static List<Section> createRight2017Cource() {
...
//		sectionList.add(new Section(speed5, TravelType.PID, condition5, null));
	...
	private static List<Section> createGateCource() {
		...
		Condition condition2 = new Condition(ConditionType.DISTANCE, 6000);
		sectionList.add(new Section(speed2, TravelType.TAIL, condition2, null));
		// 尻尾下ろし
		WheelSpeed speed3 = new WheelSpeed(-30, -30);
		Condition condition3 = new Condition(ConditionType.TIME, 500);
		sectionList.add(new Section(speed3, TravelType.TAILCONTROL, condition3, null));
		// 車体を傾ける
		WheelSpeed speed4 = new WheelSpeed(0, 0);
		condition4 = new Condition(ConditionType.TAIL_ANGLE, 73);
		sectionList.add(new Section(speed4, TravelType.TAILDOWN, condition4, null));
		// 尻尾走行
		WheelSpeed speed5 = new WheelSpeed(20, 20);
		Condition condition5 = new Condition(ConditionType.DISTANCE, 420);
		sectionList.add(new Section(speed5, TravelType.TAIL, condition5, null));
		// ゲート通過検知
		WheelSpeed speed6 = new WheelSpeed(20, 20);
		Condition condition6 = new Condition(ConditionType.NOT_OBSTACLES_DETECTION, 0.1f);
		sectionList.add(new Section(speed6, TravelType.TAILCONTROL, condition6, null));
		// 車体停止
		WheelSpeed speed7 = new WheelSpeed(0, 0);
		Condition condition7 = new Condition(ConditionType.DISTANCE, 6000);
		sectionList.add(new Section(speed7, TravelType.TAIL, condition7, null));
		// １８０度回転する
		WheelSpeed speed8 = new WheelSpeed(50, -50);
		Condition condition8 = new Condition(ConditionType.DISTANCE, 250);
		sectionList.add(new Section(speed8, TravelType.TAIL, condition8, null));
		// ライン復帰する
		WheelSpeed speed9 = new WheelSpeed(50, 0);
		Condition condition9 = new Condition(ConditionType.DISTANCE, 100);
		sectionList.add(new Section(speed9, TravelType.TAIL, condition9, null));
		WheelSpeed speed9_2 = new WheelSpeed(-50, 0);
		Condition condition9_2 = new Condition(ConditionType.DISTANCE, 100);
		sectionList.add(new Section(speed9_2, TravelType.TAIL, condition9_2, null));
		WheelSpeed speed9_3 = new WheelSpeed(0, 50);
		Condition condition9_3 = new Condition(ConditionType.DISTANCE, 100);
		sectionList.add(new Section(speed9_3, TravelType.TAIL, condition9_3, null));
		WheelSpeed speed9_4 = new WheelSpeed(0, -50);
		Condition condition9_4 = new Condition(ConditionType.DISTANCE, 100);
		sectionList.add(new Section(speed9_4, TravelType.TAIL, condition9_4, null));
		// 尻尾走行
		WheelSpeed speed10 = new WheelSpeed(20, 20);
		Condition condition10 = new Condition(ConditionType.DISTANCE, 420);
		sectionList.add(new Section(speed10, TravelType.TAIL, condition10, null));
		// ゲート通過検知
		WheelSpeed speed11 = new WheelSpeed(20, 20);
		Condition condition11 = new Condition(ConditionType.OBSTACLES_DETECTION, 0.1f);
		sectionList.add(new Section(speed11, TravelType.TAILCONTROL, condition11, null));
		condition11 = new Condition(ConditionType.NOT_OBSTACLES_DETECTION, 0.3f);
		sectionList.add(new Section(speed11, TravelType.TAILCONTROL, condition11, null));
		// 車体停止
		WheelSpeed speed12 = new WheelSpeed(0, 0);
		Condition condition12 = new Condition(ConditionType.DISTANCE, 6000);
		sectionList.add(new Section(speed12, TravelType.TAIL, condition12, null));
		// １８０度回転する
		WheelSpeed speed13 = new WheelSpeed(50, -50);
		Condition condition13 = new Condition(ConditionType.DISTANCE, 250);
		sectionList.add(new Section(speed13, TravelType.TAIL, condition13, null));
		// ライン復帰する

		// 尻尾走行
		WheelSpeed speed15 = new WheelSpeed(20, 20);
		Condition condition15 = new Condition(ConditionType.DISTANCE, 420);
		sectionList.add(new Section(speed15, TravelType.TAIL, condition15, null));
		// ゲート通過検知
		WheelSpeed speed16 = new WheelSpeed(20, 20);
		Condition condition16 = new Condition(ConditionType.OBSTACLES_DETECTION, 0.1f);
		sectionList.add(new Section(speed16, TravelType.TAILCONTROL, condition16, null));
		condition16 = new Condition(ConditionType.NOT_OBSTACLES_DETECTION, 0.3f);
		sectionList.add(new Section(speed16, TravelType.TAILCONTROL, condition16, null));
		// 車体停止
		WheelSpeed speed17 = new WheelSpeed(0, 0);
		Condition condition17 = new Condition(ConditionType.DISTANCE, 6000);
		sectionList.add(new Section(speed17, TravelType.TAIL, condition17, null));
		// 車体を戻す
		WheelSpeed speed18 = new WheelSpeed(0, 0);
		Condition condition18 = new Condition(ConditionType.TAIL_ANGLE, 90);
		sectionList.add(new Section(speed18, TravelType.TAILDOWN, condition18, null));
		// ライン復帰する
